...
<html>
  <head>
    ...
    <title>i-verve infoweb pvt ltd</title>
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#">i-verve infoweb pvt ltd</a>
      </div><!-- /.login-logo -->
  ...
  ?>
        ...
        <form method="post" action="<?php echo base_url();?>index.php/iOFRDYNBzGpVgPFgkwXWeKologin/dologin">
